...
import com.sc.semicolon.footballdua.R.drawable.ic_star_black_24dp
import com.sc.semicolon.footballdua.R.drawable.ic_star_border_black_24dp
import com.sc.semicolon.footballdua.R.id.add_to_favorite
import com.sc.semicolon.footballdua.R.menu.detail_menu
...
import kotlinx.android.synthetic.main.row_match.*
...
class DetailPrevActivity : AppCompatActivity() {
...
//    private var isFavorite: Boolean = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detail_prev)
    ...
    private fun getHome(await: Unit){
        val service: Service = Client.provideApi(
                Service::class.java)
